          ...
          <nav class="navbar navbar-expand-lg custom_nav-container">
            ...
            <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="login.php">ADMIN PORTAL</a>
                </li>
              </ul>
            </div>
          </nav>
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    ...
                    <p>
                    We are professionals when it comes to The safety of the people we have in our hands And that makes us
                    the best security guiders in Africa and the one of the best worldwide.
                    </p>
                    <div class="btn-box">
          ...
          <div class="carousel-item active">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                  I'll Admit that this company is nowhere to be found except here, just one tap and your life changes
                </p>
              </div>
            </div>
          </div>
          <div class="carousel-item ">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                  What An amazing portfolio!. easy and affordable services , My marriage went as planned due to their security from the beginning till the end. 
                </p>
              </div>
            </div>
          </div>
          <div class="carousel-item ">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                  As An artist, it was a honor to be escorted by the professionals from the Guarder co. javer canda yeeeeeeee.
                </p>
              </div>
            </div>
          </div>
