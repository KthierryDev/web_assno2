...
if(isset($_POST['send'])){  
  ...
  $injiza = "INSERT INTO suggest VALUES('','$fullname','$email','$telephone','$message')";
  $run = mysqli_query($conn, $injiza);
  if($run == true){
  echo '<script> alert("Message Sent successfully!!");</script>';
} 
else{
  echo '<script> alert("record insertion failed?, Please Try Again.");</script>';
